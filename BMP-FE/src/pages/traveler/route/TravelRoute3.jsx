...
export default function TravelRoute3() {
  ...
  useEffect(() => {
    try {
      setStep1Data(JSON.parse(localStorage.getItem(APPLICATION_CONSTANTS.STORAGE.ROUTE_STEP_1) || "{}"));
      setStep2Data(JSON.parse(localStorage.getItem(APPLICATION_CONSTANTS.STORAGE.ROUTE_STEP_2) || "{}"));
    } catch { /* ignore */ }
  ...
  const handleSaveRoute = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        localStorage.removeItem(APPLICATION_CONSTANTS.STORAGE.ROUTE_STEP_1);
        localStorage.removeItem(APPLICATION_CONSTANTS.STORAGE.ROUTE_STEP_2);
