...
import {
  ...
  TrendingUp, IndianRupee, FileText, Smartphone,
...
const RouteDetails = () => {
  ...
  const saveEditing = async () => {
    ...
    try {
      const payload = {
        departure_date: editDraft.departureDate || null,
        departure_time: editDraft.departureTime || null,
        arrival_date: editDraft.arrivalDate || null,
        arrival_time: editDraft.arrivalTime || null,
              ...
              <div className="bg-pink-50 border border-purple-100 rounded-xl p-5 shadow-sm">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    { icon: <IndianRupee className="text-green-400 text-xs" />, label: "Total Bids", value: d.performanceStats.totalBids },
