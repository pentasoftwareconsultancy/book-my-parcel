    ...
    <div className="bg-white rounded-2xl shadow-md mb-4 overflow-hidden border border-gray-100">
      <div className="p-4 sm:p-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
          <LocationBox title="Pickup Location" address={pickupText} date={delivery.pickupDate || delivery.sentDate || "—"} accent="blue" />
          <LocationBox title="Drop Location"   address={dropText}   date={delivery.dropDate   || delivery.sentDate || "—"} accent="green" />
        </div>
