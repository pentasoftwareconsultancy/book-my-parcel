  ...
  const testimonials = [
    {
      ...
      rating: 5,
      text: "Book My Parcel transformed our delivery process! Fast, reliable, and incredibly cost-effective.",
      highlight: "Transformed our delivery!"
    },
    {
      name: "Michael Chen",
      ...
      rating: 5,
      text: "The verified delivery partners and OTP system give us complete peace of mind. Reduced costs by 40%!",
      highlight: "Reduced costs by 40%!"
    },
    {
      name: "Priya Sharma",
      ...
      rating: 5,
      text: "As a small business, Book My Parcel's flexible delivery options have been a game-changer.",
      highlight: "Game-changer for business!"
    }
  ];
  ...
  return (
    <section className="pt-10 sm:pt-10 lg:pt-10 pb-0 bg-gradient-to-b from-white via-blue-50/30 to-[#FFFDF6]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 lg:grid-cols-3 gap-6 sm:gap-8">
          {testimonials.map((testimonial, i) => (
            <div
              key={i}
            className="group bg-white rounded-2xl p-6 sm:p-8 pb-10 md:pb-12 lg:pb-8 shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 relative overflow-hidden"            >
