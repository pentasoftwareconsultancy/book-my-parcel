...
export async function up(queryInterface, Sequelize) {
  ...
  if (!tableNames.includes("wallet_transactions")) {
    console.log("⚠️ wallet_transactions table not found — skipping migration safely");
    return;
  }

  console.log("🔄 Updating wallet transaction reasons...");
  ...
  console.log("✅ Wallet transaction migration completed");
}